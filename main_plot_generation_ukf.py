...
from src.estimate_ukf_joint import EstimateUkfJoint
...
#folder = 'results/ukf_with_legend'
folder = 'results/ukf_no_legend'
...
estimator = EstimateUkfJoint(alpha, kappa, beta, state_dim)
